...
//	}
	...
	public DVDPlayer dvdPlayer02(DigitalVideoDisc dvd) {
		return new DVDPlayer(dvd);//생성자 주입 bean 생성 호출자를 직접 안에 넣는다. bean 호출한것은 avengers()이다.
	}
	...
	public DVDPlayer dvdPlayer03(DigitalVideoDisc dvd) {
		DVDPlayer dvdPlayer = new DVDPlayer();//생성자 주입 bean 생성 호출자를 직접 안에 넣는다. bean 호출한것은 avengers()이다.
