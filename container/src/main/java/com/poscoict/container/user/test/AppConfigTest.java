...
public class AppConfigTest {
	...
	//Java Config2
	//자바 설정 클래스가 모여있는 베이스 패키지를 전달한다.
	//설정 클래스에 @Configuration이 반드시 필요하다.
		public static void testAppConfig02() {
			//
			ApplicationContext ac = new AnnotationConfigApplicationContext("com.poscoict.container.config.user");  //이 패키지를 스캐닝 해서 d안의 configuratuiondmf tmzosld
